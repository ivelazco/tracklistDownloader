...
- [ ] 01-01: Draft `.cursor/rules` from current `src/` patterns (Ramda, `prAll`, `tapAfter`, module boundaries).
- [ ] 01-02: Add memory/concurrency guidance (parallel caps, Playwright lifecycle, batching).
- [ ] 01-03: Document Node/engine expectations (`package.json` / README or rules cross-link).
